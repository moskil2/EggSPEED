...
fun ProfilesScreen(
    ...
    Column(
                ...
                TokenCard(modifier = Modifier.clickable { onLoad(name) }, contentPadding = 14.dp, borderColor = Tokens.WhiteBorder) {
                    Row(Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Column(Modifier.weight(1f)) {
                            ...
                            Text(tr("Dotknij, aby wczytać (podgląd)", "Tap to load (preview)", de = "Tippen zum Laden (Vorschau)", fr = "Toucher pour charger (aperçu)", es = "Toca para cargar (vista previa)", pt = "Toca para carregar (pré-visualização)", it = "Tocca per caricare (anteprima)", nl = "Tik om te laden (voorbeeld)", sv = "Tryck för att ladda (förhandsvisning)", cs = "Klepnutím načteš (náhled)", sk = "Klepnutím načítaš (náhľad)"), fontFamily = Manrope, fontSize = 12.sp, color = Tokens.TextSecondary)
                        }
                        Box(
                            Modifier.clickable { onDelete(name) }.padding(8.dp),
                            contentAlignment = Alignment.Center,
                        ) {
                            Text(tr("Usuń", "Delete", de = "Löschen", fr = "Supprimer", es = "Eliminar", pt = "Eliminar", it = "Elimina", nl = "Verwijderen", sv = "Ta bort", cs = "Odstranit", sk = "Odstrániť"), fontFamily = Manrope, fontWeight = FontWeight.SemiBold, fontSize = 12.sp, color = Tokens.Red)
                        }
                    }
                }
            }
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
            OutlinedAction(tr("Importuj .ini", "Import .ini", de = "Import .ini", fr = "Importer .ini", es = "Importar .ini", pt = "Importar .ini", it = "Importa .ini", nl = "Importeren .ini", sv = "Importera .ini", cs = "Importovat .ini", sk = "Importovať .ini"), Modifier.weight(1f), onImportFile)
            FilledAction(tr("Zapisz bieżący", "Save current", de = "Aktuelles speichern", fr = "Enregistrer l'actuel", es = "Guardar actual", pt = "Guardar atual", it = "Salva corrente", nl = "Huidige opslaan", sv = "Spara aktuell", cs = "Uložit aktuální", sk = "Uložiť aktuálny"), Modifier.weight(1f)) { newName = ""; showSaveDialog = true }
        }
        OutlinedAction(tr("Eksportuj do pliku", "Export to file", de = "In Datei exportieren", fr = "Exporter vers un fichier", es = "Exportar a archivo", pt = "Exportar para ficheiro", it = "Esporta su file", nl = "Exporteren naar bestand", sv = "Exportera till fil", cs = "Exportovat do souboru", sk = "Exportovať do súboru"), Modifier.fillMaxWidth(), onExportFile)
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = { onSaveNew(newName); showSaveDialog = false }) {
                    Text(tr("Zapisz", "Save", de = "Speichern", fr = "Enregistrer", es = "Guardar", pt = "Guardar", it = "Salva", nl = "Opslaan", sv = "Spara", cs = "Uložit", sk = "Uložiť"), color = Tokens.Blue, fontFamily = Manrope, fontWeight = FontWeight.Bold)
                }
            },
            dismissButton = {
                TextButton(onClick = { showSaveDialog = false }) {
                    Text(tr("Anuluj", "Cancel", de = "Abbrechen", fr = "Annuler", es = "Cancelar", pt = "Cancelar", it = "Annulla", nl = "Annuleren", sv = "Avbryt", cs = "Zrušit", sk = "Zrušiť"), color = Tokens.TextSecondary, fontFamily = Manrope)
                }
            },
            title = { Text(tr("Nazwa profilu", "Profile name", de = "Profilname", fr = "Nom du profil", es = "Nombre del perfil", pt = "Nome do perfil", it = "Nome del profilo", nl = "Profielnaam", sv = "Profilnamn", cs = "Název profilu", sk = "Názov profilu"), fontFamily = Sora, fontWeight = FontWeight.Bold, color = Tokens.TextPrimary) },
            text = {
                Box(
                    Modifier
                        .fillMaxWidth()
                    ...
                    if (newName.isEmpty()) {
                        Text(tr("np. Miasto 25 km/h", "e.g. City 25 km/h", de = "z. B. Stadt 25 km/h", fr = "ex. Ville 25 km/h", es = "ej. Ciudad 25 km/h", pt = "ex. Cidade 25 km/h", it = "es. Città 25 km/h", nl = "bijv. Stad 25 km/h", sv = "t.ex. Stad 25 km/h", cs = "např. Město 25 km/h", sk = "napr. Mesto 25 km/h"), fontFamily = Manrope, fontSize = 15.sp, color = Tokens.TextSecondary)
                    }
                }
            },
        )
